// Lucide-style stroke icons, 1.75px stroke
const Icon = ({ name, size = 20, className = '', strokeWidth = 1.75 }) => {
  ...
  switch (name) {
    ...
    case 'wallet': return <svg {...common}><path d="M19 7H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2Z"/><path d="M16 14a2 2 0 1 1 0-4M3 9V6a2 2 0 0 1 2-2h11"/></svg>;
    ...
    case 'piechart': return <svg {...common}><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>;
    ...
    case 'trash': return <svg {...common}><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>;
    ...
    case 'trending-down': return <svg {...common}><polyline points="22 17 13.5 8.5 8.5 13.5 2 7"/><polyline points="16 17 22 17 22 11"/></svg>;
    case 'target': return <svg {...common}><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>;
    case 'handshake': return <svg {...common}><path d="m11 17 2 2a1 1 0 0 0 1.4 0l5.6-5.6a2 2 0 0 0 0-2.8L13 4l-2 2"/><path d="M3 7 8.5 12.5"/><path d="M14 6 11 9"/><path d="M9.5 11.5 13 15"/><path d="M16 9 13 12"/></svg>;
    ...
    case 'sparkles': return <svg {...common}><path d="M12 3l1.8 4.6L18 9.4l-4.2 1.8L12 16l-1.8-4.8L6 9.4l4.2-1.8L12 3z"/><path d="M19 14l.9 2.1L22 17l-2.1.9L19 20l-.9-2.1L16 17l2.1-.9L19 14z"/><path d="M5 15l.7 1.7L7.4 17.4 5.7 18.1 5 19.8l-.7-1.7L2.6 17.4l1.7-.7L5 15z"/></svg>;
    case 'refresh': return <svg {...common}><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10"/><path d="M20.49 15a9 9 0 0 1-14.85 3.36L1 14"/></svg>;
    case 'lightbulb': return <svg {...common}><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0-4 12.7c.7.6 1 1.4 1 2.3h6c0-.9.3-1.7 1-2.3A7 7 0 0 0 12 2z"/></svg>;
    // Google G — multi-color brand logo. Drops the stroke common props since
    // this mark uses fills with the official Google brand colors.
    case 'google': return (
